...
- Card 6: Removed 35% ammo pick up bonus to make overall balancing easier and more fair for non-maxed out perks. Added ability to pick up throwables without investing into Fully Loaded skill, since throwables are not extremely effective. The pick up itself depends on the chosen throwable and requires a certain amount of ammo box pickups, instead of being RNG dependant like vanilla Fully Loaded skill, making balancing easier.  
...
- Card 1: Now allows for smoke regeneration on kill to happen while the smoke itself is active, to allow the player to use the smoke more aggressively. 
