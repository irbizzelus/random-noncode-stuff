...
| Tier level | Skill | Description |  Summary and reasons for the change(s) |
| -------- | -------- | -------- | -------- |
| Tier 4 | Fire Trap | ![](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Technician/Fire_Trap.png)  | Maximum total duration of firetraps is now 140 seconds longer for one full heist day, if you have 14 trip mines. Increased range also makes them a slightly more effective area denial tool. If you are planning to run this skill, you probably should skip the Combat Engineering skill, which buffs your trip mine's explosive damage, since you are most likely going to deal majority of your trip mine damage with fire instead of the initial explosion. |
