...
- While hosting a lobby (either online or offline) Team AI bots will now drop less ammo boxes from their kills. Every kill they get now has a 25% chance to drop ammo whenever you have 3 bots, 50% at 2 bots, and 75% at 1 bot. This only affects player-replacing-bots, and does not affect converts and sentries.
...
| Tier 1  | Combat Medic | ![](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Mastermind/Combat_Medic.png)  | This change keeps up with "Combat medic" idea while not hurting vanilla "Berserker" players and instead providing additional self sustain after revive action is complete. Additional healing this skill provides in vanilla also has a similar issue to "Up You Go", where bonus healing is based on healing amount, instead of player's health, leaving players with just 3% bonus health if played on Mayhem difficulty and above. |

### Mastermind - Controller

| Tier level | Skill | Description |  Summary and reasons for the change(s) |
| -------- | -------- | -------- | -------- |
| Tier 3 |  Stockholm Syndrome | ![](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Mastermind/Stockholm_Syndrome.png) | A new thematic panic upgrade with an obvious downside, which should be compensated by vanilla Aced stockholm if you do go to custody. This skill was added to make other adjustments within Controller sub-tree flow better. |
| Tier 2   | Confident | ![](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Mastermind/Confident.png) | Now focused more on civilian control. Pro version was moved to the "Joker" skill on the right side of the sub-tree to make Controller sub-tree make a little bit more sense, and to make maxed out convert set up slightly less expensive. |
...
| Tier 1  | Forced Friendship | ![](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Mastermind/Forced_Friendship.png) | Aced version was always extremely bad for it's cost, so now it's cheap. Converted enemies were made slightly more expensive to build minimally for, since they provide great benefits. |

### Mastermind - Sharpshooter

| Tier level | Skill | Description |  Summary and reasons for the change(s) |
| -------- | -------- | -------- | -------- |
| Tier 4 | Graze | ![](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Mastermind/Graze.png)  |  Graze is a skill that is way too powerful in vanilla if used correctly/stacked with DPS skills, so it's power was brought down, but in a twisted way. This rework now allows for much easier collaterals in situations where enemies stack up together, however with each new enemy hit the damage they take also gets reduced. This skill is still most effective with sniper rifles, since most of them deal extremely high base damage, but allowing AR's and SMG's work with this skill allows for greater build vareity, even if these weapon categories require additional damage skills to be most effective with Graze. Note that unlike vanilla version, you are now incentivezed to aim for the enemy closest to you, so that enemies behind the target are more likely to get grazed, instead of incentivezing aiming for an enemy who stands the furtherst from you, to graze everyone between you and the target, like it does in vanilla. |
...
| Tier 2   | Slow and Steady | ![](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Mastermind/Slow_And_Steady.png) | New upgrade for a slower playstyle, mostly tailored towards bipod'able weapons.  |
...
| Tier level | Skill | Description |  Summary and reasons for the change(s) |
| -------- | -------- | -------- | -------- |
| Tier 4 | Revitalized | ![](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Ghost/Revitalized.png)  |  New dodge focused skill that will help most dodge builds by providing extra safety, for moments when your armor is broken. Basic version is meant to be used with high dodge perks like Rogue, while aced is helpful for mid dodge decks like Gambler and Crook. |
