...
| Tier 2   | Swift Hands | ![](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Fugitive/Swift_Hands.png) | Magazine capacity was removed to avoid confusion with revolvers. Rate of fire bonus was moved into new "Trigger Happy". Reload speed bonus was moved here from vanilla skill "Desperado", and a new offhand reload bonus was added to improve pistols' role of a supportive secondary, since their DPS is lacking relative to other secondary options. |
| Tier 1  | Equilibrium | ![](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Fugitive/Equilibrium.png)  | All bonuses of this skill were buffed and a movement speed bonus was added. This was done to make pistols a more appealing secondary weapon option for a really cheap cost, since pistols on their own, without more expensive skills in this tree, are lacking in the DPS department. |

### Fugitive - Revenant

| Tier level | Skill | Description |  Summary and reasons for the change(s) |
| -------- | -------- | -------- | -------- |
| Tier 4 | Messiah | ![](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Fugitive/Messiah.png)  | This is more of a QOL update to make using this skill easier, while practically being a buff, since this skill is kinda "meh". |
...
| Tier 2   | Bloodthirst | ![](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Fugitive/Bloodthirst.png) | Swapped basic and aced versions around to make the cost of upgrades make more sense, since increased melee damage allows to deal with Bulldozers easier. Max stack amount and damage per stack were updated to match new melee damage, and reload boost was nerfed slighlty to compensate it's new placment in the basic version of the skill. |
