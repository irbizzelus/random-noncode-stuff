...
| Tier level | Skill | Description |  Summary and reasons for the change(s) |
| -------- | -------- | -------- | -------- |
| Tier 4 | Graze | ![](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Mastermind/Graze.png)  |  Graze is a skill that is way too powerful in vanilla if used correctly/stacked with DPS skills, so it's power was brought down, but in a twisted way. Basically this rework now crates a cone starting at first hit enemy's position, which expands the hit range, but reduces the damage, with the only caveat being a requirement to hit at least one enemy to continue growing your cone. This rework will allow for point blank graze to be nearly as effective as it's vanilla counterpart, but after just a few meters, the damage drop off will kick in strongly, reducing your potential to clear the full map in one shot. You can check this [beautiful illustration](https://raw.githubusercontent.com/irbizzelus/random-noncode-stuff/refs/heads/main/Gilza_pics/Skill_Images/Mastermind/newGrazePaintVisuals.png) on how new graze expansions work, viewed from the top. Note that shields are not affected by Graze if your weapon does not have shield AP. |
